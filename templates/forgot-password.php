<form name="lostpasswordform" id="lostpasswordform" action="<?php echo home_url( '/forgot-password/' ); ?>" method="post">
	<?php ssp_show_error(); ?>
	<p><?php _e( 'Please enter your username or email address. You will receive a link to create a new password via email.', 'stop-spammers-premium' ); ?></p>
	<p>
	...
	<p class="submit">
		<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="<?php _e( 'Get New Password', 'stop-spammers-premium' ); ?>">
	</p>
</form>
